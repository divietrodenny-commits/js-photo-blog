...
creo overlay su html, lo richiamo su js e quando clicco apre l'overley impostando su disdplay block e quando si clicca la x torna a display none. Aggiungere css sia per sistemare overlay sia per tutto il bounus.